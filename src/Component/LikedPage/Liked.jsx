...
const Liked = () => {
  ...
  return (
    <div className='mx-4 md:mx-8 lg:mx-16'>
      ...
      <div className="liked_product mt-4 p-4 border border-gray-200 rounded-lg flex flex-col md:flex-row items-center gap-4">
        <img src="https://www.beyoung.in/desktop/images/checkout/EMPTY%20CARTORDER%20PAGE..png" alt="Product" className="w-24 h-24 object-cover" />
        <div className="flex flex-col md:flex-row md:items-center gap-4 md:gap-8 w-full">
          ...
          <button className="px-4 py-2 cursor-pointer text-2xl text-white rounded"><FcCancel/></button>
      </div>
